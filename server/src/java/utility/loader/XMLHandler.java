...
class XMLHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        throw parseError(new InvalidXMLTagException(qName));
    }
    ...
    private SAXException parseError(Exception cause) {
        return new SAXException("Ошибка при чтении XML-коллекции: " + cause.getMessage(), cause);
    }
}
